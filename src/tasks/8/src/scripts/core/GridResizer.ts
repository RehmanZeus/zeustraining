...
export class GridResizer {
    ...
    //         false,           // suppressHeaderSelectionColor (so no row header highlight for previewed row)
    //         this.columnSelector?.selectedCols,
    //         cellSelectionArr,
    //         rowIndex,       // previewRowIndex (NEW)
    //         previewHeight   // previewRowHeight (NEW)
    //     );
    ...
    //     }
    //     if (this.gridMatrix.cellSelector?.colSelector) {
    //         this.gridMatrix.cellSelector.colSelector.drawSelection(this.ctx, scrollLeft, scrollTop);
    //     }
